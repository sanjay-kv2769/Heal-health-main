...
console.log(patient.result);
    ...
    // formData.append("time", patient.time);
      ...
      axios
        .post(`http://localhost:9090/api/patient-booking/update-patient/result/details/${id}`,patient)
        .then((response) => {
          console.log(response);
          setPatient(response.data.data);
        });
    ...
    <div style={{ backgroundImage: `url(${image})` }}>
      <div style={{ width: "600px", marginLeft: "auto", marginRight: "auto" }}>
        ...
        <Form.Group className=" mb-3" controlId="formBasicEmail">
            ...
            <Form.Control
              type="text"
              placeholder="Enter Lymphocytes in %"
              name="a"
              value={patient.a}
          ...
          <Form.Group className=" mb-3" controlId="formBasicEmail">
            ...
            <Form.Control
              type="text"
              placeholder="Enter Eosinophils in %"
              name="b"
              value={patient.b}
              onChange={inputChange}
            />
          ...
          <Form.Group className=" mb-3" controlId="formBasicEmail">
            ...
            <Form.Control
              type="text"
              placeholder="Enter Monocytes in %"
              name="c"
              value={patient.c}
              onChange={inputChange}
            />
          ...
          <Form.Group className=" mb-3" controlId="formBasicEmail">
            ...
            <Form.Control
              type="text"
              placeholder="Enter Basophils in %"
              name="d"
              value={patient.d}
              onChange={inputChange}
            />
